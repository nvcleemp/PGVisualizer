...
import be.ugent.twi.pg.visualizer.gui.action.ClearFaceSelectionAction;
import be.ugent.twi.pg.visualizer.gui.action.FilterAction;
import be.ugent.twi.pg.visualizer.gui.action.GrowGraphAction;
import be.ugent.twi.pg.visualizer.gui.action.Show3DAction;
import be.ugent.twi.pg.visualizer.gui.action.ShowWindowAction;
import be.ugent.twi.pg.visualizer.gui.toggler.ClipViewToggler;
import be.ugent.twi.pg.visualizer.gui.toggler.FillFacesToggler;
